...
class Admin extends CI_Controller{
	...
	public function view_detail_host($id)
	{
		...
		$this->load->view('admin/detail_host', $data);
	}
	...
	public function device()
	{
		...
		$config['base_url'] = base_url().'admin/admin/device/';
		$config['total_rows'] = $total_row;
		$config['per_page'] = 10;
		...
		// $device_name = $this->input->post('search');
		// $data['device_name'] = $this->m_device->search_device($device_name);
		// $data['links']='';
	...
	public function add_device()
	{
		...
		$this->load->view('admin/add_device', $data);
	}
	...
	public function save_device()
	{
		...
		$data['username']  = $this->session->userdata('username');
		redirect('admin/admin/device','refresh');
	}
     ...
     function search_keyword()
    {
        ...
        $data['device_name']    =   $this->m_device->search($keyword);
        $this->load->view('admin/device', $data);
    }
	...
	{
		$total_row = $this->m_user->user_num_rows();

		$config['base_url']   = base_url().'admin/admin/user/';
		$config['total_rows'] = $total_row;
		$config['per_page']   = 10;
		...
		$data['user'] = $this->m_user->user_list($config['per_page'],$from);
		$data['username']  = $this->session->userdata('username');
		...
		$data['user'] = $this->m_user->get_user_all();
		$data['username']  = $this->session->userdata('username');
	...
	public function add_user()
	{
		...
		$data['user'] = $this->m_user->get_user_all();
		$data['username']  = $this->session->userdata('username');
		$data['kodeunik'] = $this->m_user->kode_user();
	...
	public function save_user()
	{
		$data = array(
				...
				'user_level' => $this->input->post('level_user')
			);

		$this->m_user->save_user($data);
		$this->session->set_flashdata('save','information');
		redirect('admin/admin/user','refresh');
	}
	...
	public function log()
	{
		...
		$config['base_url']   = base_url().'admin/admin/log/';
		$config['total_rows'] = $total_row;
		$config['per_page']   = 10;
		...
		$data['logs'] = $this->m_log->log_list($config['per_page'],$from, $this->session->userdata('id'));
		$data['username'] = $this->session->userdata('username');
		$this->pagination->initialize($config);
		$data['pagination'] = $this->pagination->create_links();
	...
	public function delete_log($id)
	{
		...
		$this->session->set_flashdata('delete','information');
		redirect('admin/admin/log','refresh');
	}
	...
	public function host()
	{
		...
		$config['base_url']   = base_url().'admin/admin/host/';
		$config['total_rows'] = $total_row;
		$config['per_page']   = 10;
		...
		$this->load->view('admin/host', $data);
	}
	...
	public function connected()
	{
		...
		$this->load->view('admin/connected', $data);
	}
	...
	public function disconnected()
	{
		...
		$this->load->view('admin/disconnected', $data);
	}
	...
	public function unreachable()
	{
		...
		$this->load->view('admin/unreachable', $data);
	}
