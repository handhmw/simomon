...
class Admin extends CI_Controller{
	...
	public function kirim_email($device){
		...
		$result = $this->email
		        ->from('handrihermawan404@gmail.com')
		        ->reply_to('sundapoke4@somedomain.com')
		        ->to('handrihermawan505@gmail.com')
		        ->subject($subject)
		        ->message($body)
		        ->send();
		return $result;
...
//////////////////////////////////////////////////////////////////////////////
	...
	public function user()
	{
		...
		$config['base_url']   = base_url().'subadmin/subadmin/user/';
		$config['total_rows'] = $total_row;
		$config['per_page']   = 10;
		...
		$this->load->view('subadmin/user', $data);
	}
	...
	public function add_user()
	{
		...
		$this->load->view('subadmin/add_user', $data);
	}
	...
	public function edit_user($id)
	{
		...
		$this->load->view('subadmin/edit_user', $data);
	}
	...
	public function save_user()
	{
		...
		$this->session->set_flashdata('save','information');
		redirect('subadmin/subadmin/user','refresh');
	}
...
////////////////////////////////////////////////////////////////////////////////
	...
	public function log()
	{
		...
		$data['logs']     = $this->m_log->log_list($config['per_page'],$from);
		$data['username'] = $this->session->userdata('username');
	...
	public function host()
	{
		...
		$from = $this->uri->segment('4');
		$data['error']     = '';
		$data['data_host'] = $this->m_host->host_list($config['per_page'],$from);
		$data['username']  = $this->session->userdata('username');
	...
	//Jumlah Status Device Pada Navigation 
	...
	//Menegetahui Jumlah Data Berdasarkan Status Device/////////////////////////////////////////
