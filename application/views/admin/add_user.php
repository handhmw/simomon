			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form method="post" class="form-horizontal" role="form" action="<?php echo base_url();?>admin/admin/save_user" class="form-horizontal">
						  <fieldset>
							<div class="control-group">
							  <label class="control-label" for="typeahead">Name ID </label>
							  <div class="controls">
								<input type="text" class="form-control" name="id_user" required oninvalid="invalidMsg(this);" oninput="invalidMsg(this);" value="<?= $kodeunik; ?>" readonly>
							  </div>
							</div>
							<div class="control-group">
