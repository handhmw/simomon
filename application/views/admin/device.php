...
<!-- start: Content -->
    <div id="content" class="span10">
            ...
            <ul style="margin-left: -1px">
                <a href="<?php echo base_url();?>admin/admin/add_device" class="btn btn-md btn-success" role="button">
                              ...
                              <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <a href="<?php echo base_url();?>admin/admin/edit_device/<?php echo $device->device_id;?>" class="btn btn-xs btn-primary" role="button" title="ubah"><i class="halflings-icon white edit"></i></a>&nbsp;
                                        <a href="<?php echo base_url();?>admin/admin/delete_device/<?php echo $device->device_id;?>" onclick="return confirm('Apakah Anda Yakin?');" class="btn btn-xs btn-danger" role="button" title="hapus"><i class="halflings-icon white trash"></i></a>
                                    </td>
                                </tr>
