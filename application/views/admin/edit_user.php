				...
				<div class="box span12">
					...
					<div class="box-content">
						<?php 
							foreach ($user as $usr) {
						?>
						<form method="post" class="form-horizontal" role="form" action="<?php echo base_url();?>admin/admin/update_user/<?php echo $usr->user_id; ?>" class="form-horizontal">
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="form-control" name="level_user" required oninvalid="invalidMsg(this);" oninput="invalidMsg(this);" value="<?php echo $usr->user_level; ?>" >
							  </div>
							</div>
							<!-- <div class="control-group">
							  <label class="control-label" for="selectError3">Level</label>
								<div class="controls">
								  <select name="level_user" id="selectError3">
									<option><?php echo $usr->user_level; ?></option>
								  </select>
								</div>
							</div>
							 -->
							<div class="form-actions">
							  ...
							  <a class="btn btn-danger" href="<?php echo base_url(); ?>admin/admin/user">Back</a>
							</div>
						  </fieldset>
						</form>   
						<?php } ?>
