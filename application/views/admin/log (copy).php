...
<div id="content" class="span10">
    ...
    <?php } ?>
	<!-- <form method="post" class="form-horizontal" role="form" action="<?php echo base_url();?>admin/admin/search_log" class="navbar-form navbar-left" role="search">
	  	<div class="form-group">
		    <input type='text' placeholder='Pencarian...' name='qcari' class='form-control'>
						  ...
						  <tbody>
							<?php 
								...
								<td style="text-align: center;">
                                    <a href="<?php echo base_url();?>admin/admin/delete_log/<?php echo $log->id_log;?>" onclick="return confirm('Apakah Anda Yakin?');" class="btn btn-xs btn-danger" role="button" title="hapus"><i class="halflings-icon white trash"></i></a> 
                                </td>
							</tr>
							<?php endforeach; ?>
