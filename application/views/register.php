                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>JANCUX</strong> Login Form</h1>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>Login to JANCUX Network Monitoring</h3>
                            ...
                            <div class="form-bottom">
			                    <form role="form" method="post" class="login-form">
			                    	<div class="form-group">
			                        	...
			                        	<input type="text" name="username" placeholder="First Name..." class="form-username form-control" id="username">
			                        </div>
                                    <div class="form-group">
                                        <label class="sr-only" for="username">Last Name</label>
                                        <input type="text" name="username" placeholder="Last Name..." class="form-username form-control" id="username">
                                    </div>
                                    <div class="form-group">
                                        <label class="sr-only" for="username">Email</label>
                                        <input type="email" name="username" placeholder="Email@mail.com..." class="form-username form-control" id="username">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="sr-only" for="username">Level</label>
                                        <input type="text" name="username" placeholder="Level..." class="form-username form-control" id="username">
                                    </div>
			                        <div class="form-group">
