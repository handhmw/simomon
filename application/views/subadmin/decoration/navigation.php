...
<div class="row-fluid">
	<div class="span3 statbox purple" onTablet="span6" onDesktop="span3">
		...
		<div class="footer">
		<a href="<?php echo base_url(); ?>subadmin/subadmin/connected"> Full Report</a>
		</div>	
	</div>
	<div class="span3 statbox green" onTablet="span6" onDesktop="span3">
		...
		<div class="footer">
		<a href="<?php echo base_url(); ?>subadmin/subadmin/disconnected"> Full Report</a>
		</div>
	</div>
	<div class="span3 statbox blue noMargin" onTablet="span6" onDesktop="span3">
		...
		<div class="footer">
		<a href="<?php echo base_url(); ?>subadmin/subadmin/unreachable"> Full Report</a>
		</div>
	</div>
	<div class="span3 statbox yellow" onTablet="span6" onDesktop="span3">
		...
		<div class="footer">
		<a href="<?php echo base_url(); ?>subadmin/subadmin/rto"> Full Report</a>
		</div>
	</div>	
