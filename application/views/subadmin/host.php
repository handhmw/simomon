                            ...
                            foreach ($data_host as $host): ?>
                                <tr>
                                   ...
                                   <td style="text-align: center;">
                                        <a href="<?php echo base_url();?>subadmin/subadmin/view_detail_host/<?php echo $host->device_id;?>" class="btn btn-xs btn-primary" role="button" title="Detail"><i class="halflings-icon white zoom-in"></i></a>&nbsp;
                                    </td>
                                </tr>
...
<script>
    ...
    setInterval(function() {
        $('table.listHost > tbody > tr').each(function(index, el) {
                ...
                //console.log(dom_ip);
                $.post('<?php echo base_url(); ?>subadmin/subadmin/ping', {host_ip: dom_ip}, function(data, textStatus, xhr) {
    ...
    setInterval(function(){
        $.get('<?php echo base_url(); ?>/subadmin/subadmin/check_log', function(data) {
            /*optional stuff to do after success */
            console.log(data);
        });
